# Planets
## Specific rule - [Planets provide players with resources and influence. Planets are on system tiles and each has a name, a resource value, and an influence value. Some planets also have traits.]
### Rule points
...
6. A planet card has both a readied and exhausted state. When a planet is readied, it is placed faceup. When a planet is exhausted, it is placed facedown.
7. A player can spend a readied planet’s resources or influence.
8. A player cannot spend an exhausted planet’s resources or influence.
