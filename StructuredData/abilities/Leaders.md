# Leaders
## Specific rule - [Each player has several faction–specific leader cards that represent characters with unique abilities.]
### Rule points
1. Each faction has three leaders; one agent, one commander, and one hero.

    1. The Nomad’s The Company faction ability grants them two additional agents, for a total of five leaders.
2. A player’s leaders are placed on their leader sheet during setup.
...
#### Agents
3. An agent does not need to be unlocked and begins the game in a readied state. They can be exhausted by resolving their abilities, and they ready during the Ready Cards step of the status phase.

#### Commanders
4. A commander must be unlocked to use its abilities. A player unlocks their commander if they fulfill the conditions listed after the “Unlock” header.
...
5. A commander cannot be exhausted.
6. The Alliance promissory note allows a player to share their commander’s ability with another player.

    1. A commander’s owner can still use their commander’s ability, even if another player has their Alliance promissory note.

#### Heroes
7. A hero needs to be unlocked to use their abilities. A player unlocks their hero if they fulfill the conditions listed after the “Unlock” header.
...
8. A hero cannot be exhausted.
9. A hero is purged after its abilities are resolved.
