# Blockaded
## Specific rule - [A player’s unit with Production is blockaded if it is in a system that does not contain any of their ships and contains other players’ ships.]
### Rule points
